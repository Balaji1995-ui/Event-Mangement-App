...
<body>
    ...
    <main>
        ...
        <!-- Hero End -->
         <?php
   require 'admin/conn.php';
$cats= mysqli_query($con,"select*from image where id='1'");
                ...
                <div class="row">
                        ...
                        <div class="blog_left_sidebar">
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0 " src="assets/img/header/<?php echo $cat['image1']?>" alt="">
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0 " src="assets/img/header/<?php echo $cat['image2']?>" alt="">
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0 " src="assets/img/header/<?php echo $cat['image3']?>" alt="">
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0 " src="assets/img/header/<?php echo $cat['image4']?>" alt="">
                            ...
                            <nav class="blog-pagination justify-content-center  d-flex">
                                <ul class="pagination container ">
                                    ...
                                    <li class="page-item">
                                        <a href="Event.php" class="page-link">1</a>
                                    </li>
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            ...
                            <div class="blog_item_img">
                            <img class="card-img rounded-0" src="assets/img/header/<?php echo $cat['image5']?>" alt="">
                  ...
                  <source src="videos.mp4" type="video/ogg">
                      ...
                      <!-- <iframe width="780" height="450"src="<?php echo $cat['video1']?>" 
                        title="RISK Conference 2019 - Official Event Highlight Video" 
                        frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                         allowfullscreen></iframe> -->

                         <video controls width="780" height="450">

    <source src="assets/img/header/<?php echo $cat['video1']?>"
            type="video/webm">
    ...
    Download the
    <a href="assets/img/header/<?php echo $cat['video1']?>">WEBM</a>
    or
    <a href="assets/img/header/<?php echo $cat['video1']?>">MP4</a>
    video.
</video>
                                </div>
                            </aside>
                            ...
                            <asside class="p-1">
                            <div class="blog_item_img">
                            <img class="card-img rounded-0" src="assets/img/header/<?php echo $cat['image6']?>" alt="">
                    ...
                    <asside class="p-1 col-lg-4">
                            ...
                            <img class="card-img rounded-0 " src="assets/img/header/<?php echo $cat['image7']?>" alt="">
                                </div>
                            </aside>
